...
import com.shiki.chatapp.adapters.ChatAdapter;
import com.shiki.chatapp.databinding.ActivityChatBinding;
import com.shiki.chatapp.models.ChatMessage;
import com.shiki.chatapp.models.User;
import com.shiki.chatapp.network.ApiClient;
import com.shiki.chatapp.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(String messageType, String msg) {
        ...
        if (conversionId != null) {
            updateConversion(msg, messageType);
        } else {
            ...
            conversion.put(Constants.KEY_LAST_MESSAGE_TYPE, messageType);
        ...
        if (!isReceiverAvailable) {
            try {
                ...
                if (messageType.equals("text")) {
                    ...
                    data.put(Constants.KEY_MESSAGE, "Sent a Photo");
                }
    ...
    private void setListeners() {
        ...
        binding.layoutSend.setOnClickListener(v -> sendMessage("text", binding.inputMessage.getText().toString()));
        binding.layoutExtra.setOnClickListener(v -> {
    ...
    private void updateConversion(String message, String messageType) {
        DocumentReference documentReference =
                database.collection(Constants.KEY_COLLECTON_CONVERSATIONS).document(conversionId);
        documentReference.update(
                ...
                Constants.KEY_LAST_MESSAGE_TYPE, messageType,
